   ...
   if (data)
      return (
         <Container maxWidth='lg' className='w-full flex flex-col items-center min-h-100-header'>
            <HomePageHeader />
            <div className='h-300 sm:h-350 md:h-450 group shadow-bannerShadow relative flex flex-col items-center justify-center w-full overflow-hidden rounded-2xl'>
               <img
               ...
               />
               <div className='absolute bottom-0 left-0 flex flex-col items-start justify-start w-full h-auto px-3 py-4 450:py-5 md:py-6 text-white bg-gradient-to-t from-black/60 from-0 to-transparent bg-opacity-20'>
                  <CardHeader
               ...
               <Box className='absolute top-4 right-4 lg:top-6 lg:right-6 transition duration-300 lg:translate-x-150% lg:group-hover:translate-x-0 lg:group-hover:right-5 w-auto'>
                  <Link className='no-underline' to={`/${data.posts[data.posts.length - 1].slug}`}>
                     <Button
                        variant='contained'
                        className=' justify-center shadow-arrowButton gap-1 text-black bg-sky-100 px-3 py-0.5 sm:px-4 sm:py-1 items-center rounded-2xl'
                     >
                        Read post
            ...
            <Typography
               className='w-full pt-0 600:pt-6 text-base sm:text-1.05rem'
               component='p'
               variant='p'
               color='black'
               fontWeight={400}
            ...
            <Stack className='flex flex-col 730:flex-row w-full my-5'>
